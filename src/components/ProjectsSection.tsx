...
const projects = [
  {
    ...
    githubLink: 'https://github.com/samaysusumanth/hospital-management', // Replace with actual link
  ...
  },
  {
    ...
    githubLink: 'https://github.com/samaysusumanth/ebook-zone', // Replace
  ...
  },
  {
    ...
    githubLink: 'https://github.com/samaysusumanth/emotion-feedback', // Replace
...
const ProjectsSection = () => {
  return (
    <Section id="projects" bgColor="bg-slate-50" textColor="text-slate-800">
      <h2 className="text-3xl md:text-4xl font-bold text-primary-navy mb-12 text-center">My Projects</h2>
