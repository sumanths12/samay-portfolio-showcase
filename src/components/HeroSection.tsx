...
const HeroSection = () => {
  ...
  return <section id="home" className="relative min-h-screen flex items-center justify-center bg-background text-foreground section-padding">
      ...
      <div className="relative z-10 text-center content-max-width">
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12">
          <div className="md:w-2/3 text-center md:text-left">
            ...
            <p className="text-xl sm:text-2xl text-muted-foreground mb-2">Software Developer</p>
          ...
          <div className="md:w-1/3 mt-8 md:mt-0 flex justify-center">
            <img src="https://i.postimg.cc/rmKs2TKP/me.png" alt="Samay Susumanth" className="rounded-full w-48 h-48 sm:w-60 sm:h-60 lg:w-72 lg:h-72 object-cover border-4 border-primary shadow-xl" />
          </div>
        </div>
      </div>
    </section>;
